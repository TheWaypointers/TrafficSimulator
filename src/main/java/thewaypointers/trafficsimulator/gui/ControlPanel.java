...
public class ControlPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        Line2D.Float line4 = new Line2D.Float(0, 560, 200, 560);
        Line2D.Float line5 = new Line2D.Float(0, 595, 200, 595);
        g2.draw(line2);
        g2.draw(line4);
