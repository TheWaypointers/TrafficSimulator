...
public class VehicleFactory {
    ...
    public IVehicle buildVehicle(SimpleDirectedWeightedGraph<String, DefaultWeightedEdge> roadGraph, HashMap<Node, ArrayList<RoadEdge>> nodeGraphMap) {
        ...
        return new Car(VehicleType.CarNormal, firstRoad.getSpeedLimit(), decisions, firstRoad.getRoad(), ((float) roadGraph.getEdgeWeight(firstRoad.getRoad())), originNode, Lane.Left);
    }
